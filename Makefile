#############################################################################
# Makefile for building: image-finder
# Generated by qmake (3.1) (Qt 5.9.2)
# Project:  image-finder.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile image-finder.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = image-finder1.0.0
DISTDIR = /home/archie/Git/image-compositor/.tmp/image-finder1.0.0
LINK          = g++
...
Makefile: image-finder.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile image-finder.pro
